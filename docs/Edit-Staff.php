...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $StaffID = test_input($_POST["username"]);
...
<html>
    ...
    <body>
        <div id="path">
            <p><i class="fas fa-tachometer-alt"></i> Child / Edit Staff</p>
        </div>
        <form id="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <div id="form_title">
                <p><i class="far fa-money-bill-alt"></i>Edit Staff</p>
            </div>
            <div id="form_body">
            <div class="group">
                    <label>Staff ID</label>
                    <input type="text" id="staffID" name="staffID" value="<?php echo $StaffID ?>">
                    <p id="staffIDWarn"><?php echo $StaffIDError ?></p>
                </div>
                <div class="group">
                ...
                if($post=='admin'){
                    echo "<script>
                    document.getElementById('post').value='admin';
                    </script>";
                }
                if($post=='principal'){
                    echo "<script>
                    document.getElementById('post').value='principal';
                    </script>";
                }
                if($post=='matron'){
                    echo "<script>
                    document.getElementById('post').value='matron';
                    </script>";
                }
                ?>
                <div class="group">
